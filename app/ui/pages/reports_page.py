...
class ReportsPage(QWidget):
    ...
    def _build_danger_zone(self) -> QFrame:
        ...
        desc = QLabel(
            ...
            "يتم <b>نسخ قاعدة البيانات احتياطياً</b> تلقائياً قبل أي حذف، "
            "فلا شيء يُفقد نهائياً — يمكنك استعادة النسخة من مجلد "
...
class RestartConfirmDialog(QDialog):
    def __init__(self, parent=None):
        ...
        warn = QLabel(
            ...
            "يتم <b>حفظ نسخة احتياطية كاملة</b> قبل التنفيذ، فيمكنك استعادة البيانات لاحقاً عند الحاجة."
        )
